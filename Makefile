...
CODEFILES   = 	main.c nustdfuncs.c stage00.c graphic.c sixtwelve.c sixtwelve_tex.c sixtwelve_helpers.c gfxinit.c gamemath.c dialogue.c pieces.c pawn.c rook.c bishop.c queen.c knight.c wall.c board.c cursor.c ogre.c  dialogue/dialoguelookup.c cast_sprites/castlookup.c
