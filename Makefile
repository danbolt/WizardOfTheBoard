...
CODEFILES   = 	main.c nustdfuncs.c stage00.c graphic.c sixtwelve.c sixtwelve_tex.c sixtwelve_helpers.c gfxinit.c gamemath.c dialogue.c pieces.c pawn.c rook.c bishop.c queen.c knight.c king.c wall.c board.c cursor.c ogre.c  dialogue/dialoguelookup.c cast_sprites/castlookup.c
...
RAWDATAOBJ = sprites/hud_icons.bino sprites/floor_tiles.bino sprites/noise_backgrounds.bino sprites/display_text.bino dialogue/dialogueBuffers.bino cast_sprites/packedtextures.bino
